...
def make_cfg(path):
    ...
    elif path == 'cfg/resnet18_cifar10_stochastic.py':
        import cfg.resnet18_cifar10_stochastic
        return cfg.resnet18_cifar10_stochastic.cfg
    else:
